...
[System.CRepr] public struct Matrix
{
    ...
    public void RotateX(int32 angle) mut                                               => RSDKTable.MatrixRotateX(&this, angle);
    public void RotateY(int32 angle) mut                                               => RSDKTable.MatrixRotateY(&this, angle);
    public void RotateZ(int32 angle) mut                                               => RSDKTable.MatrixRotateZ(&this, angle);
    public void RotateXYZ(int32 x, int32 y, int32 z) mut                               => RSDKTable.MatrixRotateXYZ(&this, x, y, z);
